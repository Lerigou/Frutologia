      ...
      <div className="footer-items">
        ...
        <div className="texts-container">
            ...
            <div className="contact">
                ...
                <div className="art">
                    <p>Artes utilizadas: <a href="https://pixabay.com/de/users/julieta_masc-5768105/">julieta_masc</a></p>
                </div>

                <div className="api">
                    <p>Api utilizada: <a href="https://www.fruityvice.com/">fruityvice.com</a></p>
                </div>
            </div>
        ...
        <div className="feedback-container">
            ...
            <div className="text">
                <p>
                Encontrou algum problema ou simplesmente quer deixar uma mensagem
                para nós? Clique no botão abaixo!
                </p>
            </div>

            <div className="btn-feedback">
                <button className="btn" onClick={handleOpenDialog}> Escrever comentário </button>
            </div>
